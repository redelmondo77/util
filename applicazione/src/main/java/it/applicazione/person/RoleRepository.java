...
/**
 * Repository class for <code>Role</code> domain objects All method names are
...
public interface RoleRepository extends Repository<Role, Integer> {
    ...
    /**
	 * Save a <code>Role</code> to the data store, either inserting or updating
	 * it.
	 *
	 * @param role
	 *            the <code>Role</code> to save
